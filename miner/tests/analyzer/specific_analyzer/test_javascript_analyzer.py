...
def test_JavaScriptAnalyzer(tmp_path, resource_dir, get_ready_specific_analyzer):
...
def test_create_with_analysis_javascript_file(tmp_path, create_temp_file, get_ready_specific_analyzer):
